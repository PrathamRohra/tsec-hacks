  ...
  return (
    <>
      ...
      <form className="login-form"  onSubmit={handleSubmit}>
        ...
        <input
          type="text"  className="new-input" placeholder="Name"
          value={name}
      ...
      <label>
        ...
        <input
          type="email" className="new-input" placeholder="Email"
          value={email}
      ...
      <label>
        ...
        <input className="new-input" placeholder="******"
          type="password"
          value={password}
